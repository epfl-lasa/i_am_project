...
private:
  ...
  std::unique_ptr<hitting_DS> generateHitting7_ =
      std::make_unique<hitting_DS>(iiwaPositionFromSource_[IIWA_1], objectPositionFromSource_);
  std::unique_ptr<hitting_DS> generateHitting14_ =
      std::make_unique<hitting_DS>(iiwaPositionFromSource_[IIWA_2], objectPositionFromSource_);
