...
template<typename T>
Eigen::Matrix<T, 4, 1>
Utils<T>::slerpQuaternion(Eigen::Matrix<T, 4, 1>* q, Eigen::Matrix<T, Eigen::Dynamic, 1> t, int size) {
...
template<typename T>
Eigen::Matrix<T, 3, 1>
Utils<T>::quaternionToAngularVelocity(Eigen::Matrix<T, 4, 1> q1, Eigen::Matrix<T, 4, 1> q2, T gain) {
...
template<typename T>
Eigen::Matrix<T, 6, 7>
Utils<T>::getGeometricJacobian(Eigen::Matrix<T, 7, 1> joints, Eigen::Matrix<T, 3, 1> rEEx, ROBOT_ID robotID) {
